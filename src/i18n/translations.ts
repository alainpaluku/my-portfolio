export const translations = {
  en: {
    ...
    articles: {
      title: 'Articles',
      subtitle: 'Latest insights and research',
      readMore: 'Read More',
    ...
    marquee: ['SMART GRIDS', 'RUST', 'GOLANG', 'TYPESCRIPT', 'MATLAB/SIMULINK', 'KICAD', 'PCB DESIGN', 'SCADA SYSTEMS', 'IOT PROTOCOLS', 'EMBEDDED C', 'POWER ANALYSIS'],
  },
  fr: {
    nav: {
      home: 'Accueil',
    ...
    articles: {
      title: 'Articles',
      subtitle: 'Dernières publications et recherches',
      readMore: 'Lire Plus',
    ...
    marquee: ['SMART GRIDS', 'RUST', 'GOLANG', 'TYPESCRIPT', 'MATLAB/SIMULINK', 'KICAD', 'PCB DESIGN', 'SCADA SYSTEMS', 'PROTOCOLES IOT', 'EMBEDDED C', 'ANALYSE PUISSANCE'],
  },
} as const;
