...
export const icons = {
  ...
  automation: `<rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><circle cx="8.5" cy="8.5" r="1.5"></circle><path d="M21 15.5c0 .83-.67 1.5-1.5 1.5s-1.5-.67-1.5-1.5.67-1.5 1.5-1.5 1.5.67 1.5 1.5z"></path><path d="M14 7.5c0 .83-.67 1.5-1.5 1.5S11 8.33 11 7.5 11.67 6 12.5 6s1.5.67 1.5 1.5z"></path><path d="M8.5 12l3.5 3 5.5-5.5"></path>`,
  ...
  arrowUp: `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 10l7-7m0 0l7 7m-7-7v18" />`,
